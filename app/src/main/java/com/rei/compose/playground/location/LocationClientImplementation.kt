package com.rei.compose.playground.location
...
import com.rei.compose.playground.util.hasLocationPermission
        ...
        return callbackFlow {
            ...
            val locationCallback = object : LocationCallback() {
                override fun onLocationResult(result: LocationResult) {
                    ...
                    Log.d("ComposeLocation", "onLocationResult: ${result.locations.last()}")
